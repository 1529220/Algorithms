...
////Brunel University, DISC Module CS2004, 2016-2017
package lab6;
...
import java.util.*;
	public class ThreeSorts 
		...
		public static ArrayList<Integer> RandomArray(int n)
		{
			...
			//Random Numbers between 0-255
			Random rand = new Random();
			rand.setSeed(System.currentTimeMillis());
			for (int i = 0 ;i <n ; i++)
			{
			  list.add(Math.abs(rand.nextInt() % 256));
			}
				
			return list;
			
		}
		public static void ShowArray(ArrayList<Integer> arraylistRandom){
			
			System.out.println(arraylistRandom);
		}
