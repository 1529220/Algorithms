...
public class PcDifficultNaC extends JFrame implements ActionListener {
...
public static void main() {
	// start the game
	PcDifficultNaC game = new PcDifficultNaC();
...
private void pcTurn() {
	...
	if(counter == 0){//if is the first round, put X in the middle or in the first button (choose randomly one of these two)
		for(int k=0;k<1;k++){
	...
	else if(counter == 2){//if counter is = 2, check the best solution to win the game
		if(buttons[0].getText().equals("X")&& buttons[8].getText().equals("")){
			buttons[8].setText("X");
		}
		else if(buttons[0].getText().equals("X")&& buttons[4].getText().equals("")){
			buttons[4].setText("X");
		}
	...
	else if(counter == 4){//if counter = 4, Defense(check if the user is winning)
	...
	//if not, try to attack
		...
		else if(buttons[4].getText().equals("")){ //if the computer cannot win, put X in the corners or in the middle
			buttons[4].setText("X");
		}
	...
	else if (counter == 6){ //if counter =6, attack(see if the computer can win)
		if(buttons[0].getText().equals("X") && buttons[2].getText().equals("X") && buttons[1].getText().equals("")) {
			buttons[1].setText("X");
		}
		else if(buttons[0].getText().equals("X") && buttons[6].getText().equals("X") && buttons[3].getText().equals("")) {
			buttons[3].setText("X");
		...
		else{ //if any of the above cases are happening, put X in the one of the corners or in the middle
