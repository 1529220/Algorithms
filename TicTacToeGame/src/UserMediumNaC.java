...
public class UserMediumNaC extends JFrame implements ActionListener {
...
public static void main() {
	// start the game
	UserMediumNaC game = new UserMediumNaC();
...
private void pcTurn() {
	...
	//check if there are two X close, then put O in the same line
			...
			buttons[6].setText("O");
		}//if there are none, put an O in one of the corners or in the middle if empty
		...
		else{//if anyone is empty, search for a random empty button
			for(int i=0;i<9;i++){
...
private void checkwinner() {
	...
	if (counter == 9){//if we are in the last turn and anyone wan it's a DRAW call the function to print the Label DRAW
		result="DRAW";
