...
public class UserEasyNaC extends JFrame implements ActionListener {
...
public static void main() {
	// start the game
	UserEasyNaC game = new UserEasyNaC();
...
private void pcTurn() {
	//create a random number to choose a random button, check if the button if empty, if yes the computer writes O if no
	//if all the buttons are taken so if the counter is equal 9, empty the table, otherwise call this function again
	//and search another random number.
