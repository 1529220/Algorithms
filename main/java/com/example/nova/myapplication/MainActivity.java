package com.example.nova.myapplication;
        ...
        loginButton.setOnClickListener(
                new View.OnClickListener()
                {
                    public void onClick(final View view)
                    {
                        ...
                        //myWebView.loadUrl("javascript:(function(){document.getElementById('bGetTimetable').click();})()");
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                myWebView.loadUrl("javascript:(function(){document.getElementById('LinkBtn_mystudentsettimetable').click();})()");
                                //myWebView.loadUrl("javascript:(function(){document.getElementById('dlType').value=('List Timetable').click();})()");
                                myWebView.loadUrl("javascript:(function(){document.getElementById('bGetTimetable').click();})()");
                                myWebView.loadUrl("javascript:(function(){document.getElementById('bGetTimetable').click();})()");
                                myWebView.loadUrl("javascript:(function(){document.getElementById('bGetTimetable').click();})()");
                                myWebView.loadUrl("javascript:(function(){document.getElementById('bGetTimetable').click();})()");
